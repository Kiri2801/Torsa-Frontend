...
export default {
  ...
  methods: {
    limpiar(){
      if(this.datosUsuario.dni>=0 && this.datosUsuario.dni<8){
        this.datosPersonales.nombrel = "";
        this.datosPersonales.apellidoPaterno = "";
              ...
              else 
              {
                ...
                axios.get(
                  ...
                  ).then((response) => 
                  {
                    ...
                    {
                      this.MensajeDeInfo(res.message+' - El DNI puede ser invalido');
                      this.show = false;
                    }
                  })
                  .catch(() => 
      ...
      if (!this.$v.contactoEmergencia.$anyError) 
      {
        ...
        axios
          ...
          .then((response) => 
          {
            ...
            {
              this.$swal("Usuario Registrado","Para inciar sesion por favor verique su correo electronico","success");
              this.LimpiarCampos();
              this.show = false;
            } 
            else 
    ...
    MensajeDeInfo(mensaje)
    {
      this.$swal("Info!", mensaje, "info");
    },
  },
  validations: {
    datosPersonales: {
